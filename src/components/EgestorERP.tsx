...
const EgestorERP = () => {
  ...
  const egestorLink = "https://www.egestor.com.br/afl/17475";

  return (
    <section className="py-12 sm:py-16 bg-white overflow-hidden">
      <div className="container px-4 sm:px-6 mx-auto max-w-6xl">
        {/* Two-column layout for desktop, stack on mobile */}
        <div className="flex flex-col md:flex-row md:items-center md:gap-8 lg:gap-12 mb-8 sm:mb-10">
        ...
        <div className="flex justify-center animate-fade-in px-4">
          ...
          >
            <button className="w-full py-3 bg-[#7CFFA0] hover:bg-[#6DF090] text-black font-medium rounded-full transition-all duration-200 shadow-lg hover:shadow-xl transform hover:scale-[1.02] text-sm sm:text-base">
              Teste grátis
            </button>
          </a>
        </div>
